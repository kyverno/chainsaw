...
| `skipDelete` | `bool` | :white_check_mark: |  | *No description provided.* |
...
| `skipDelete` | `bool` | :white_check_mark: |  | <p>Skip determines whether the resource should be deleted after the test step is executed.</p> |
