...
type Client interface {
	Delete(context.Context, ctrlclient.Object) error
	Apply(context.Context, ctrlclient.Object) error
	Assert(context.Context, unstructured.Unstructured) error
	Error(context.Context, unstructured.Unstructured) error
}
