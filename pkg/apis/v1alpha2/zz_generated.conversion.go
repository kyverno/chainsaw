...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*TestStep)(nil), (*v1alpha1.TestStep)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_TestStep_To_v1alpha1_TestStep(a.(*TestStep), b.(*v1alpha1.TestStep), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1alpha1.TestStep)(nil), (*TestStep)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_TestStep_To_v1alpha2_TestStep(a.(*v1alpha1.TestStep), b.(*TestStep), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_TestStep_To_v1alpha1_TestStep(in *TestStep, out *v1alpha1.TestStep, s conversion.Scope) error {
	out.Name = in.Name
	out.TestStepSpec = in.TestStepSpec
	return nil
}

// Convert_v1alpha2_TestStep_To_v1alpha1_TestStep is an autogenerated conversion function.
func Convert_v1alpha2_TestStep_To_v1alpha1_TestStep(in *TestStep, out *v1alpha1.TestStep, s conversion.Scope) error {
	return autoConvert_v1alpha2_TestStep_To_v1alpha1_TestStep(in, out, s)
}

func autoConvert_v1alpha1_TestStep_To_v1alpha2_TestStep(in *v1alpha1.TestStep, out *TestStep, s conversion.Scope) error {
	out.Name = in.Name
	out.TestStepSpec = in.TestStepSpec
	return nil
}

// Convert_v1alpha1_TestStep_To_v1alpha2_TestStep is an autogenerated conversion function.
func Convert_v1alpha1_TestStep_To_v1alpha2_TestStep(in *v1alpha1.TestStep, out *TestStep, s conversion.Scope) error {
	return autoConvert_v1alpha1_TestStep_To_v1alpha2_TestStep(in, out, s)
}
