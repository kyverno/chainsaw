...
func (in *Collector) DeepCopyInto(out *Collector) {
	*out = *in
	if in.PodLogs != nil {
		...
		*out = new(PodLogsCollector)
		(*in).DeepCopyInto(*out)
	}
	if in.Events != nil {
		in, out := &in.Events, &out.Events
		*out = new(EventsCollector)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventsCollector) DeepCopyInto(out *EventsCollector) {
	*out = *in
	in.ObjectSelector.DeepCopyInto(&out.ObjectSelector)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventsCollector.
func (in *EventsCollector) DeepCopy() *EventsCollector {
	if in == nil {
		return nil
	}
	out := new(EventsCollector)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodLogsCollector) DeepCopyInto(out *PodLogsCollector) {
	*out = *in
	in.ObjectSelector.DeepCopyInto(&out.ObjectSelector)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodLogsCollector.
func (in *PodLogsCollector) DeepCopy() *PodLogsCollector {
	if in == nil {
		return nil
	}
	out := new(PodLogsCollector)
