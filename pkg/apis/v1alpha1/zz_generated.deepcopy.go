...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Modifier) DeepCopyInto(out *Modifier) {
	*out = *in
	if in.Merge != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Modifier.
func (in *Modifier) DeepCopy() *Modifier {
	if in == nil {
		return nil
	}
	out := new(Modifier)
