...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MatchedCheck) DeepCopyInto(out *MatchedCheck) {
	*out = *in
	if in.Match != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MatchedCheck.
func (in *MatchedCheck) DeepCopy() *MatchedCheck {
	if in == nil {
		return nil
	}
	out := new(MatchedCheck)
	in.DeepCopyInto(out)
	return out
}
